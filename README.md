...
For every invalid input, it will show a relevant error message.
Simply run this in a code editor or terminal program such as Terminal or Command Prompt to walk through the functions. 
If there are any questions, don't hesitate to reach out! Thank you, and hope you enjoy.
